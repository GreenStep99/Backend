...
public enum ErrorCode {
    ...
    DUPLICATED_EMAIL(HttpStatus.BAD_REQUEST.value(), "M005", "이미 사용되고 있는 이메일입니다."),
    INVALID_MEMBER_INFO(HttpStatus.BAD_REQUEST.value(), "M006", "잘못된 사용자 정보입니다."),
    ...
    INVALID_VALUE(HttpStatus.BAD_REQUEST.value(), "F003", "잘못된 태그 정보입니다."),
