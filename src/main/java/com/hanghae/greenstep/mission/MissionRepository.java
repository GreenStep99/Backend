...
public interface MissionRepository extends JpaRepository<Mission,Long> {
    ...
    @Query(value = "select * from mission where mission_type = 'weekly' order by RAND() limit 4", nativeQuery = true)
    ...
    @Query(value = "select * from mission where mission_type = 'challenge' order by RAND() limit 1", nativeQuery = true)
